#!/usr/bin/env sh
# Universal installer for pactgen. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/pactgen.git"
echo "Installing pactgen ..."
