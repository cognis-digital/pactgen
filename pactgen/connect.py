"""Native cognis-connect emit for pactgen — forward findings to any platform.

Maps pactgen's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    pactgen ... --format json | pactgen-emit --to stix
    pactgen-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
